<h1 = align=center>𝙸𝚃 𝚂𝚄𝙿𝙿𝙾𝚁𝚃 & 𝚃𝚁𝙾𝚄𝙱𝙻𝙴𝚂𝙷𝙾𝙾𝚃𝙸𝙽𝙶</h1>
...
- [`2. ANKI DECK INSTALLATION SUPPORT`](#2-ANKI-DECK-INSTALLATION-SUPPORT)
- [`3. NETWORK SECURITY GROUP ACCESS`](#3-NETWORK-SECURITY-GROUP-ACCESS)
- [`4. SYSTEM SERVICE ERROR`](#4-SYSTEM-SERVICE-ERROR)
- [`5. TENABLE SCAN ABORTING`](#5-TENABLE-SCAN-ABORTING)
- [`6. REMOTE DESKTOP CONNECTION FAILURE`](#6-REMOTE-DESKTOP-CONNECTION-FAILURE)
- [`7. SSH CONNECTION FAILURE`](#7-SSH-CONNECTION-FAILURE)
- [`8. ADMINISTRATOR USER CONFLICT`](#8-ADMINISTRATOR-USER-CONFLICT)
- [`9. AZURE VM VISIBILITY ISSUE`](#9-AZURE-VM-VISIBILITY-ISSUE)
- [`10. DELAYED .TXT TRIGGER`](#10-DELAYED-.TXT-TRIGGER)
- [`11. DISA WINDOWS 10 STIG HELP`](#11-DISA-WINDOWS-10-STIG-HELP)
- [`12. VARIATION IN VULNERABILITY SCAN RESULTS`](#12-VARIATION-IN-VULNERABILITY-SCAN-RESULTS)
- [`13. NETWORK SECURITY GROUP ACCESS / CONFIGURATION`](#13-NETWORK-SECURITY-GROUP-ACCESS-/-CONFIGURATION)
- [`14. ONBOARDING LINUX VM TO MDE`](#14-ONBOARDING-LINUX-VM-TO-MDE)
- [`15. DISA WINDOWS 10 STIG HELP`](#15-DISA-WINDOWS-10-STIG-HELP)
- [`16. DISA WINDOWS 10 STIG HELP`](#16-DISA-WINDOWS-10-STIG-HELP)
- [`17. DISA WINDOWS 10 STIG HELP`](#17-DISA-WINDOWS-10-STIG-HELP)
- [`18. CORRECTING ADMINISTRATOR USER GROUP`](#18-CORRECTING-ADMINISTRATOR-USER-GROUP)
- [`19. MICROSOFT SENTINEL WORKBOOK MAP`](#19-MICROSOFT-SENTINEL-WORKBOOK-MAP)
